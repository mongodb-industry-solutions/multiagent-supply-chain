...
import { 
  findNearestCarriersTool, 
  validateServiceCoverageOriginTool, 
  validateServiceCoverageDestinationTool,
  formatAlternativesTool 
} from "./tools.js";
...
const prompt = ChatPromptTemplate.fromMessages([
  [
    ...
    Available tools:
    - validate_service_coverage_origin: **USE THIS FIRST** - Check if carriers serve the ORIGIN location within their service areas
    - validate_service_coverage_destination: **USE THIS SECOND** - Check if carriers serve the DESTINATION location within their service areas
    ...
    **Coverage Validation Rules**:
    ...
    - Always call BOTH validate_service_coverage_origin AND validate_service_coverage_destination before recommending
